    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
      ...
      >
        ...
        <div className="mb-4 pr-8">
          <h2 className="text-xl font-bold text-white">Add Trader</h2>
          <p className="mt-1 text-sm text-gray-400">Create a new trader configuration</p>
        </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      tradingStrategy: e.target.value as Trader['tradingStrategy'],
                    })
                  }
                  className="w-full appearance-none rounded-md bg-gray-700/50 px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-sky-500"
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      holdingPeriod: e.target.value as Trader['holdingPeriod'],
                    })
                  }
                  className="w-full appearance-none rounded-md bg-gray-700/50 px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-sky-500"
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      positionStrategy: e.target.value as Trader['positionStrategy'],
                    })
                  }
                  className="w-full appearance-none rounded-md bg-gray-700/50 px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-sky-500"
                >
